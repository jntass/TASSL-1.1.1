...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_DTLS13_SN_ENC, 0), "dtls13_sn_enc"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_OUTPUT_SM2_CERT_CHAIN, 0),
     "ssl3_output_sm2_cert_chain"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_ADD_SM2_CERT_CHAIN, 0),
     "ssl_add_sm2_cert_chain"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CERT_SET0_CHAIN, 0),
     "ssl_cert_set0_chain"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CHECK_ENC_PRIVATE_KEY, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CHECK_SRVR_SM2_CERT_AND_ALG, 0),
     "ssl_check_srvr_sm2_cert_and_alg"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_CHECK_ENC_PRIVATE_KEY, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_DERIVE_SM2, 0), "ssl_derive_SM2"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_ENC_CERT, 0), "ssl_set_enc_cert"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET_ENC_PKEY, 0), "ssl_set_enc_pkey"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_ACK, 0), "tls_construct_ack"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CKE_SM2, 0),
     "tls_construct_cke_sm2"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CKE_SM2DH, 0),
     "tls_construct_cke_sm2dh"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CKE_RSA, 0),
     "tls_process_cke_rsa"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CKE_SM2DHE, 0),
     "tls_process_cke_sm2dhe"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PROCESS_CKE_SM2ECC, 0),
     "tls_process_cke_sm2ecc"},
...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BAD_SM2_CERT), "bad sm2 cert"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_SET_UNIFIED_HDR), "set unified hdr"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_SM2_CERT_NOT_FOR_SIGNING),
    "sm2 cert not for signing"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNABLE_TO_FIND_ENC_CERT),
    "unable to find enc cert"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNKNOWN_GMTLS_CERTIFICATE_TYPE),
    "unknown gmtls certificate type"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNKNOWN_GMTLS_KEY_TYPE),
    "unknown gmtls key type"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNKNOWN_GM_CERTIFICATE_TYPE),
    "unknown gm certificate type"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNKNOWN_GM_KEY_TYPE),
    "unknown gm key type"},
