...
/* SM2 auth */
#  define SSL_aSM2DSA            0x00000100L

#define SSL_aCERT \
    (SSL_aRSA | SSL_aDSS | SSL_aECDSA | SSL_aGOST01 | SSL_aGOST12 | SSL_aSM2DSA)
...
# endif
    ...
    X509 *peer;
    /* This is the enc cert and type for the other end, only for GMTLS */
    X509 *peer_enc;
...
struct ssl_st {
    ...
    EVP_CIPHER_CTX *enc_read_sn_ctx; /* DTLS1.3 read sn_key */
    unsigned char read_iv[EVP_MAX_IV_LENGTH]; /* TLSv1.3 static read IV */
    EVP_MD_CTX *read_hash;      /* used for mac generation */
    COMP_CTX *compress;         /* compression */
    COMP_CTX *expand;           /* uncompress */
    EVP_CIPHER_CTX *enc_write_ctx; /* cryptographic state */
    EVP_CIPHER_CTX *enc_write_sn_ctx; /* DTLS1.3 write sn_key */
...
# define SM1_1_VERSION_DEFAULT_SM2_CURVE_ID 0x0
...
#define TLSEXT_SIGALG_sm2sig_sm3                                0x0708 /* rfc 8998 */
...
__owur int tls13_derive_key(SSL *s, const EVP_MD *md,
                            ...
                            size_t keylen);
__owur int tls13_derive_snkey(SSL *s, const EVP_MD *md, 
                            const unsigned char *secret, unsigned char *snkey, 
                            size_t snkeylen);
...
#  endif
__owur int ssl_check_srvr_sm2_cert_and_alg(X509 *x, SSL *s);
...
__owur EVP_PKEY *ssl_generate_param_group_sm2(void);
#  endif                        /* OPENSSL_NO_EC */
