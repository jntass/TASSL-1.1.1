...
# define EVP_PKEY_CTX_set1_peer_id(ctx, id, id_len) \
        EVP_PKEY_CTX_ctrl(ctx, -1, -1, \
                                EVP_PKEY_CTRL_SET1_PEER_ID, (int)id_len, (void*)(id))

# define EVP_PKEY_CTX_get1_peer_id(ctx, id) \
        EVP_PKEY_CTX_ctrl(ctx, -1, -1, \
                                EVP_PKEY_CTRL_GET1_PEER_ID, 0, (void*)(id))

# define EVP_PKEY_CTX_get1_peer_id_len(ctx, id_len) \
        EVP_PKEY_CTX_ctrl(ctx, -1, -1, \
                                EVP_PKEY_CTRL_GET1_PEER_ID_LEN, 0, (void*)(id_len))

# define EVP_PKEY_CTX_set_responsor(ctx, responsor) \
        EVP_PKEY_CTX_ctrl(ctx, -1, -1, \
                                EVP_PKEY_CTRL_SET_RESPONSOR, (responsor), NULL)

# define EVP_PKEY_CTX_set1_ekey(ctx, ekey) \
        EVP_PKEY_CTX_ctrl(ctx, -1, -1, \
                                EVP_PKEY_CTRL_SET1_EKEY, 0, (void *)(ekey))

# define EVP_PKEY_CTX_set1_peer_ekey(ctx, peer_ekey) \
        EVP_PKEY_CTX_ctrl(ctx, -1, -1, \
                                EVP_PKEY_CTRL_SET1_PEER_EKEY, 0, (void *)(peer_ekey))
...
# define EVP_PKEY_CTRL_SET1_PEER_ID                      (EVP_PKEY_ALG_CTRL + 14)
# define EVP_PKEY_CTRL_GET1_PEER_ID                      (EVP_PKEY_ALG_CTRL + 15)
# define EVP_PKEY_CTRL_GET1_PEER_ID_LEN                  (EVP_PKEY_ALG_CTRL + 16)
# define EVP_PKEY_CTRL_SET_RESPONSOR                     (EVP_PKEY_ALG_CTRL + 17)
# define EVP_PKEY_CTRL_SET1_EKEY                         (EVP_PKEY_ALG_CTRL + 18)
# define EVP_PKEY_CTRL_SET1_PEER_EKEY                    (EVP_PKEY_ALG_CTRL + 19)
/* KDF types */
